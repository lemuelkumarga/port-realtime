...
grViz(paste0("
  digraph pipeline {
    ...
    DB [label = 'Database', fillcolor = '",`@c`(txt,0.1),"', fontcolor = '",`@c`(txt),"', shape= rectangle, width = 5]
    
    UT_Script [label = 'updateTable\nScript', fillcolor = '",`@c`(1),"', shape=diamond]
    AV_API [label = 'Stocks API', fillcolor = '",`@c`(txt),"', shape=rectangle]
    { rank = same; UT_Script, AV_API}

    AV_API -> UT_Script -> DB [ dir=back, color='",`@c`(1),"' ]
    AV_API -> UT_Script -> DB [ color='",`@c`(1),"' ]
    
    Highcharts [label = 'Tracker', fillcolor = '",`@c`(bg),"', fontcolor = '",`@c`(txt),"', shape=plaintext]
    AWS_API [label = 'AWS API', fillcolor = '",`@c`(txt),"', shape=plaintext]
    GR_Script [label = 'getReturns\nScript', fillcolor = '",`@c`(2),"', shape = diamond]
...
grViz(paste0("
  digraph pipeline {
    ...
    node [fontname = '",`@f`,"', fontsize = 12, fontcolor = '",`@c`(bg),"', penwidth=0, color='",`@c`(txt),"', style=filled, shape=rectangle]
    edge [fontname = '",`@f`,"', fontsize = 12, fontcolor = '",`@c`(ltxt),"', color='",`@c`(ltxt),"']
